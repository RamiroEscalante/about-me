...
import { MyCareer } from "../my-career/my-career";
import {
  User,
  Code,
  Briefcase,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-32">
          <div className="text-center">
            ...
            <div className="flex justify-center mb-4 sm:mb-6">
              <img
                src="/public/my_photo/yo_fondo.jpeg" // Cambia por la ruta real
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-300 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-4">
              Software Development student with a passion for Frontend
              Development. Creating user-friendly and responsive web experiences
            ...
            <div className="flex flex-wrap justify-center gap-2 sm:gap-4 mb-6 sm:mb-8 px-4">
              {[
                ...
                <span
                  key={tech}
                  className="px-3 sm:px-4 py-1 sm:py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white/80 text-xs sm:text-sm font-medium"
                >
                  {tech}
                </span>
              ))}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-16 space-y-8 sm:space-y-16">
        ...
        <section
          id="about"
          className="bg-gradient-to-br from-white to-slate-50 border border-slate-200/60 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-lg"
        >
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-slate-600 leading-relaxed text-base sm:text-lg">
              Software Development student with a strong interest in Frontend
              Development. I enjoy creating user-friendly and responsive
              websites using HTML, CSS, JavaScript, and React, looking forward
              to improving my skills and learning new technologies.
            </p>
            <p className="text-slate-600 leading-relaxed text-base sm:text-lg mt-4">
              My goal is to gain experience and work on projects that would help
              me become a better developer, contributing to meaningful solutions
      ...
      <footer className="bg-slate-900 text-white py-8 sm:py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-slate-400 text-sm sm:text-base">
            ©2026 Ramiro Damian Escalante Cadena. Built with React and Tailwind
            CSS.
          </p>
        </div>
      </footer>
